...
// dns-sd -R Bridge _hap local 1234 pv=1.0 id=b1:42:90:21:73:9d c#=1 s#=1 sf=1 ff=0 md=HAP-Model-Name
func main() {
    bridge_info := model.NewAccessoryInfoService("b1:42:90:21:73:9d", "Rev1", "Matthias Hochgatterer", "My Bridge")        
    bridge_accessory := model.NewAccessory()
    bridge_accessory.AddService(bridge_info.Service)
    
    thermostat_info := model.NewAccessoryInfoService("001-002-003", "Model1a", "Matthias Hochgatterer", "Thermostat")
